...
namespace WixTest.Tests.Tools.Light.Help
{
    ...
    public class HelpTests : WixTests
    {
        ...
        public void Help()
        {
            ...
            light.ExpectedOutputStrings.Add("usage:  light.exe [-?] [-b bindPath] [-nologo] [-out outputFile] objectFile [objectFile ...] [@responseFile]");
            light.ExpectedOutputStrings.Add("-ai        allow identical rows, identical rows will be treated as a warning (deprecated)");
            light.ExpectedOutputStrings.Add("-ad        allow duplicate directory identities from other libraries (deprecated)");
            light.ExpectedOutputStrings.Add("-au        (experimental) allow unresolved references");
            light.ExpectedOutputStrings.Add("           (will not create a valid output) (deprecated)");
            ...
            light.ExpectedOutputStrings.Add("-bf        bind files into a wixout (only valid with -xo option) (deprecated)");
            light.ExpectedOutputStrings.Add("-binder <classname>  specify a specific custom binder to use provided by");
            light.ExpectedOutputStrings.Add("                     an extension (deprecated)");
            ...
            light.ExpectedOutputStrings.Add("-dut       drop unreal tables from the output image (deprecated)");
            ...
            light.ExpectedOutputStrings.Add("-sadmin    suppress default admin sequence actions (deprecated)");
            light.ExpectedOutputStrings.Add("-sadv      suppress default adv sequence actions (deprecated)");
            light.ExpectedOutputStrings.Add("-sloc      suppress localization");
            light.ExpectedOutputStrings.Add("-sma       suppress processing the data in MsiAssembly table (deprecated)");
            light.ExpectedOutputStrings.Add("-ss        suppress schema validation of documents (performance boost) (deprecated)");
            light.ExpectedOutputStrings.Add("-sts       suppress tagging sectionId attribute on rows (deprecated)");
            light.ExpectedOutputStrings.Add("-sui       suppress default UI sequence actions (deprecated)");
            light.ExpectedOutputStrings.Add("-sv        suppress intermediate file version mismatch checking (deprecated)");
            light.ExpectedOutputStrings.Add("-sw[N]     suppress all warnings or a specific message ID");
            light.ExpectedOutputStrings.Add("           (example: -sw1009 -sw1103)");
            ...
            light.ExpectedOutputStrings.Add("           (example: -wx1009 -wx1103)");
            ...
            light.ExpectedOutputStrings.Add("Binder arguments:");
            ...
            light.ExpectedOutputStrings.Add("-eav       exact assembly versions (breaks .NET 1.1 RTM compatibility)");
            ...
            light.ExpectedOutputStrings.Add("-O1        optimize smart cabbing for smallest cabinets (deprecated)");
            light.ExpectedOutputStrings.Add("-O2        optimize smart cabbing for faster install time (deprecated)");
            ...
            light.ExpectedOutputStrings.Add("-spsd      suppress patch sequence data in patch XML to decrease bundle");
            light.ExpectedOutputStrings.Add("           size and increase patch applicability performance");
            light.ExpectedOutputStrings.Add("           (patch packages themselves are not modified)");
            light.ExpectedOutputStrings.Add("-sval      suppress MSI/MSM validation");
            light.ExpectedOutputStrings.Add("Environment variables:");
            light.ExpectedOutputStrings.Add("   WIX_TEMP   overrides the temporary directory used for cab creation, msm exploding, ...");
            light.ExpectedOutputStrings.Add("For more information see: http://wixtoolset.org/");
