...
namespace WixTest.Tests.Tools.Lit.Help
{
    ...
    public class HelpTests : WixTests
    {
        ...
        {
            lit.ExpectedOutputStrings.Add("usage:  lit.exe [-?] [-nologo] [-out libraryFile] objectFile [objectFile ...] [@responseFile]");
            ...
            lit.ExpectedOutputStrings.Add("-loc <loc.wxl>  bind localization strings from a wxl into the library file");
            ...
            lit.ExpectedOutputStrings.Add("For more information see: http://wixtoolset.org/");
        }
    }
}
